...
| `a0533057932/redis-docs-cli` | `latest` / `0.3.1` | 8090 | CLI playground proxy (Flask) | לא — רק אם `cli.enabled=true` |
...
docker tag a0533057932/redis-docs-cli:latest REGISTRY/redis-docs-cli:0.3.1
docker push REGISTRY/redis-docs-cli:0.3.1
...
| `cli.image.tag` | `latest` | תג תמונת CLI proxy (ברשת סגורה: `0.3.1`) |
