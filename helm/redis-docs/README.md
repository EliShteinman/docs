...
```bash
helm install redis-docs redis-docs-2.0.1.tgz
```
...
```bash
helm install redis-docs redis-docs-2.0.1.tgz -f my-values.yaml
```
...
```bash
helm upgrade redis-docs redis-docs-2.0.1.tgz -f my-values.yaml
```
