...
Today we are happy to announce the general availability (GA) of [RedisTimeSeries](https://oss.redis.com/redistimeseries) v1.0. RedisTimeSeries is a Redis module developed by Redis to enhance your experience managing time series data with Redis.

### Active-Active Redis – Now with Sorted Sets and Lists

We’re delighted to announce the availability of [Redis Enterprise v5.2](https://redis.io/redis-enterprise/software/downloads/), with much-anticipated features such as Active-active support with Conflict-free Replicated Data Types (CRDTs) for Sorted Sets and Lists.

### Redis for Fast Data Ingest

Most modern industries — ranging from finance and retail to entertainment and IoT — require software with the ability to rapidly collect, store and process large volumes of data.
