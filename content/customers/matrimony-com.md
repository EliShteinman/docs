---
title: "Exceeds high availability and response requirements for 3.5 millions users"
...
[Watch the video](https://youtu.be/-uqYL8250hM?si=6pA7lS9GyBMkCHGO)

> "Moving from the community edition of Redis to Redis Enterprise is just the first step for Matrimony.com, and I personally look forward to continued improvements in both performance and the end user experience. The new product features from Redis Enterprise will be explored, evaluated and accordingly considered for use if found suitable and relevant."
