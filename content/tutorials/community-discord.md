...
The [Redis Discord server](https://discord.gg/redis) is a place where you can learn, share, and collaborate about anything and everything Redis. Whether you need real-time community support, want to share a project, or are looking for the latest Redis developer news, this is the place to be.

## What you'll find

- **Real-time help** — Get your questions answered by fellow Redis developers and community experts.
- **Project sharing** — Show off what you're building with Redis and get feedback.
- **News and updates** — Stay informed about Redis releases, events, and new content.
- **Networking** — Connect with users from the community, [Redis University](/tutorials/university/), and Redis Inc.

New to Redis? Check out the [quick start guide](/tutorials/howtos/quick-start/) to get up and running, or explore free courses at [Redis University](/tutorials/university/).

## How to join

If you already have a Discord account, joining is easy. Just go to [https://discord.gg/redis](https://discord.gg/redis) and you're in.

If you don't have a Discord account, you'll need to [create one](https://discord.com/register). Once you have an account, you can [download Discord](https://discord.com/) for your desktop, get the mobile app, or just use it in a browser.

## Server rules

Once you are on the server, you should be aware of our rules:
...
- Abide by the [**Redis Community Guidelines & Code of Conduct**](https://redis.io/community/community-guidelines-code-of-conduct/).
