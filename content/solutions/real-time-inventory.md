...
[Watch the video](https://www.youtube.com/embed/H-3esKQlv5g)
...
![Redis](/images/site-mirror/4ef0de32eb30ead879796abc322f39372baa552b-557x61.svg)
...
Redis Enterprise can [elastically scale on-demand with zero downtime](https://redis.io/redis-enterprise/technology/linear-scaling-redis-enterprise/). You don’t need to overprovision infrastructure or disrupt service to resize database clusters. That’s important as retailers cope with demanding seasonal events like Black Friday.

### Data consistency and bilateral updates between stores and enterprise systems

Globally distributed real-time inventory systems benefit from the use of Redis Enterprise deployments as an [Active-Active, geo-distributed database](https://redis.io/active-active/). You can gracefully handle bilateral inventory updates between stores and enterprise systems without compromising latency or availability.

### Flexible data modeling

Redis Enterprise provides [multiple data models](https://redis.io/redis-enterprise/multi-model/) to store inventory related data and reduce technology sprawl. Devs can choose the data model best suited to their application design, performance, and data access requirements.

### Accurate, low-latency inventory searches

Searches need to be speedy—more than speedy, really – when shoppers look for items. With the Redis Enterprise built-in [search and query engine,](https://redis.io/redis-enterprise/technology/redis-search/) you can rely on instant indexing of new data and search queries that run [four times faster](/blog/search-benchmarking-redisearch-vs-elasticsearch/) than traditional search databases.
