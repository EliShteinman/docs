---
title: "4 Reasons to Join the $100K “Build on Redis” Hackathon—And Tips on How to Win"
linkTitle: "4 Reasons to Join the $100K “Build on Redis” Hackathon—And Tips on How to Win"
url: "/blog/4-reasons-to-join-the-redis-hackathon/"
description: "The Redis community is constantly innovating, and our annual hackathons bring creative minds together and provide developers with a platform to build new ideas using Redis. Last year we challenged..."
date: 2021-04-07
blogCategories:
- "Announcements"
- "Company"
...
[Redis Enterprise Cloud ](/try-free/)is not only blazingly fast, but also versatile and packed with functionality and tools—you can build anything and everything using Redis rather than patching together multiple databases. Whether you’re collecting billions of events ([Redis Streams)](https://redis.io/docs/latest/develop/), storing JSON documents ([RedisJSON](/learn/modules/redisjson)), querying and indexing your data ([RediSearch](/learn/modules/redisearch)), analyzing a stream ([RedisTimeSeries](/learn/modules/redistimeseries)), making real-time recommendations ([RedisGraph](https://redis.io/learn/howtos/redisgraph/getting-started)), or detecting fraud ([RedisAI](https://oss.redis.com/redisai/)), you can do it all and do it fast.
...
[Click here to view video](https://www.youtube.com/embed/xEL39DDC9Z4)
...
The top 10 winners of the Redis hackathon will be promoted on our [tech blog](/blog/tech-blog/) and [social media](https://twitter.com/Redis&sa=D&source=editors&ust=1617741069493000&usg=AOvVaw2e3auyOlMHl5gRI4LphNls)—plus, they will also have an opportunity to be a guest on our [RedisPods](https://redispods.simplecast.com/) podcast. Top winners may also have an opportunity to write a guest blog.
...
“Individually you specialize, together we transform.” A hackathon is all about engaging minds. It is not simply an individual achievement. Try to convince and attract competent developers and a good designer (for visually appealing UI/mockups) to your team. Diversified brains from different parts of the world with different types of expertise—and at least one strong communication specialist—can lead your team to success. [Join the Redis Discord channel ](https://discord.com/invite/redis)and start hunting for your right team.

**2. Do your homework**

It’s important to know your organizers and their purpose in running the hackathon. Focus on the theme of the hackathon event. [Learn about the Redis Enterprise Cloud free tier](/try-free/) and [Redis modules.](https://redis.io/docs/interact/search-and-query/)** Read the hackathon rules (and read them again!).**

**3. Choose the right tool**

Choose your tech stack wisely. You must use at least one Redis Enterprise module. Each team must use a free [Redis Enterprise Cloud account](/try-free/) (if your app is using just one module) or use the [Redismod](https://github.com/RedisLabsModules/redismod) (Redis Enterprise modules) Docker image if your app needs multiple modules attached to a single Redis database (e.g. RedisJSON + RediSearch). GitHub is a perfect place to showcase your original work.
...
Take advantage of this free opportunity to challenge yourself to build something memorable, purposeful, and rewarding. The hackathon opens soon, so make sure to [register](/redisconf/registration/) before April 15! Further details will be available after April 15.

And if you’d like to brush up on your Redis skills before you start hacking, sign up for our [free training courses](/redisconf/training/), which will open a week before RedisConf 2021. These brand new training courses and more than 60 breakout sessions will be available at RedisConf 2021, so don’t wait—sign up now!

## Questions?

Ask us anything at [redisconf@redis.com](mailto:redisconf@redis.com) or in the #hackathon channel on [Discord.](https://discord.gg/redis)
