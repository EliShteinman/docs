---
title: "The Data Economy: Taking a Data-Driven Approach to Customer Experience"
linkTitle: "The Data Economy: Taking a Data-Driven Approach to Customer Experience"
url: "/blog/data-economy-customer-experience-with-data-driven-approach/"
...
*By Isaac Sacolick, Contributor · Published 31 May 2022 · updated 27 March 2025*

![Blog tile image](/images/site-mirror/b8e31efb25775b75b4a4d5fff0ad5c2c056358f1-500x356.webp)
...
In recent years, we’ve seen myriad new titles created to reflect the importance of customer experience, machine learning, and digital transformation. At [Citizens Financial Group](https://www.citizensbank.com/HomePage.aspx), which is among the top 25 largest banks in the United States, this is evidenced in a role created two years ago: [Chief Experience Officer](/business/). It’s a customer-focused role designed to ensure Citizens Bank builds capabilities that will continuously allow it to serve customers better while leveraging data to differentiate itself from competitors.
...
For technologists and data scientists, the lesson here is to learn the customer outcomes and pain points by partnering with business leaders. Then, work backward on what’s optimal, from[ data structures](/redis-enterprise/data-structures/) to[ cloud infrastructure](/redis-enterprise-cloud/overview/), that meet short and longer-term objectives.

## How to think about the power of real-time data

As the Chief Experience Officer, Johnson has a laser focus on improving the customer experience, and one key way to do that is to use real-time data. Data is critical in [financial services](/industries/financial-services/), from fraud protection to[ using data-driven insights](/docs/redis-for-financial-services/) to personalize experiences for customers. And the ability to tap real-time data to deliver instant experiences can be another way banks differentiate themselves.

In the interview, Johnson discusses a couple of areas where real-time data provides improved services to customers in the form of overdraft protection and[ real-time fraud prevention](/solutions/fraud-detection/). She suggests leaders ask themselves these questions when thinking about the power of real-time data and its role in building new products and services.
