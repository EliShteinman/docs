...
linkTitle: "Efficient Bulk Hash Insertion with Redis 8.10’s HIMPORT"
url: "/blog/efficient-bulk-hash-insertion-with-redis-810s-himport/"
description: "I’m not a Ruby developer, and my code samples might make that clear. However, there are two reasons I’m using Ruby for the examples in this article:"
date: 2026-08-24
blogCategories:
- "Tech"
authors:
...
1. Its support for a new Redis command: HIMPORT.
...
1. Repeats the exact same steps using HIMPORT, enabling a fair comparison.
...
You can find the full source code and executable examples on [Github](https://github.com/nosqlgeek/himport_demo).
