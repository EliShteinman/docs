---
title: "Should I Submit to Speak at RedisConf2020?"
linkTitle: "Should I Submit to Speak at RedisConf2020?"
url: "/blog/should-i-submit-to-speak-at-redisconf2020/"
description: "It’s that time of year again! We’re ramping up for RedisConf2020, and our goal is to provide a platform for the most interesting and useful Redis talks from around the globe. To make sure we host..."
date: 2020-02-04
blogCategories:
- "Company"
authors:
...
If you’ve never replied to a CFP before, the process can seem intimidating, but it’s really quite easy. Simply log in to [our RedisConf20 CFP form](https://sessionize.com/redisconf2020/) and **fill out the required information by February 15, 2020**. That’s all there is to it.
...
- **The level **of the talk helps conference goers self-select the talks that best align with their own Redis maturity. You have three choices:
  1. *Introduction: *Talks aimed at those who are new to Redis.
  1. *Intermediate:* Talks for people who have used Redis a little bit, but maybe not very deeply.
  1. *Advanced:* Hard-core talks for people deeply involved in Redis.
...
1. **Who you are professionally: **Name, title, company/project, etc.
1. **Why you are important: **Please share a little bit about your professional and educational background, and why attendees should pay attention to what you have to say.
1. **Something fun that personalizes you: **Where you live, interesting hobbies, family, pets, and so on.
...
[Click here to view video](https://www.youtube.com/embed/r-kzqZM0b9c)

Uli Hitzel talks about Bambleweeny, a Redis HTTP interface with OAuth

[Click here to view video](https://www.youtube.com/embed/uxcr9TnDQ_A)

Processing Real Time Volcano Seismic Measurements Through Redis by David Chaves and Elzbieta Malinowski

[Click here to view video](https://www.youtube.com/embed/ILueZX2uOQo)

Shrif Nada, from LiveRamp and his talk “Beyond PFCount: Tiny Big Data Counting Engine”

[Click here to view video](https://www.youtube.com/embed/aRaS4k55jJ0)

Internet Archive’s Jim Nelson speaking on “Work Stealing For Fun And Profit”

### RedisConf18

[Click here to view video](https://www.youtube.com/embed/JL5uqkRNBJE)

Redis Fault Injection by Khalid Lafi

[Click here to view video](https://www.youtube.com/embed/TyqMM8pGWc0)

Fail Safe Starvation Free Durable Priority Queues in Redis from Jesse Willett

[Click here to view video](https://www.youtube.com/embed/gvQRg4DJDIE)
...
Odds are if you’re reading this blog post and you’re already a Redis user you have something valuable to say. We enthusiastically welcome first-time speakers, experienced speakers, small-business Redis users, web-scale Redis users, and everyone in between as well as, of course, presenters of all genders and all backgrounds. What are you waiting for? Go to the [RedisConf2020 CFP form](https://sessionize.com/redisconf2020/) today—before time runs out!
