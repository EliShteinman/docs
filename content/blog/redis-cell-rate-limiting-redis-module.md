---
title: "redis-cell: a Rate Limiting Redis Module"
linkTitle: "redis-cell: a Rate Limiting Redis Module"
url: "/blog/redis-cell-rate-limiting-redis-module/"
description: "It is my absolute pleasure to present you with this guest post by Brandur Leach, redis-cell‘s author and winner of the 1st place in the Redis Modules Hackathon. The module is an efficient..."
date: 2017-01-24
blogCategories:
- "Company"
- "Tech"
...
So why bother? Well, although I could probably be considered to be nominally literate in C, I don’t have anywhere near the expertise to be confident that I wouldn’t write a program that contained a memory overrun or some other unsafe operation that would manifest as a program-killing segmentation fault. As evidenced by widespread issues like [Heartbleed](https://en.wikipedia.org/wiki/Heartbleed), even highly competent C developers are not beyond this class of mistake.
