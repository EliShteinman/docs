...
linkTitle: "What is prompt caching? LLM speed & cost guide"
url: "/blog/what-is-prompt-caching/"
description: "If you're building with large language models (LLMs) in production, you've probably noticed two things: latency spikes that make your app feel sluggish, and token costs that climb faster than you..."
date: 2026-03-10
blogCategories:
- "Tech DE"
authors:
...
1. **System prompt:** Stable per deployment
1. **Reference documents:** Stable per session or task
1. **Conversation history:** Grows, but older turns stay fixed
1. **User query:** Almost always changes, so it goes last
