---
title: "Up to 30% Price Reduction for Redis Cloud on Windows Azure"
linkTitle: "Up to 30% Price Reduction for Redis Cloud on Windows Azure"
url: "/blog/up-to-30-price-reduction-for-redis-cloud-on-windows-azure/"
description: "Today we’re proud to announce a price reduction for Redis Cloud on Windows Azure. In line with Window’s Azure price reduction of up to 22% on memory-intensive compute instances across Windows,..."
date: 2014-02-06
blogCategories:
- "Company"
authors:
...
Current Windows Azure users building highly scalable apps with Redis Cloud will immediately benefit from the price reduction… no action required. See our current pricing for Windows Azure and other public clouds [here](/redis-enterprise-cloud/pricing/).
...
Sign up today at [www.redis.com](/?signup) for a free 25MB Redis instance.

Questions? Contact me at [cameron@redis.com](mailto:cameron@redis.com) or a twitter [@Redis](http://www.twitter.com/redis).
