...
linkTitle: "Redis is now available under the AGPLv3 open source license"
url: "/blog/agplv3/"
description: "The rise of hyperscalers like AWS and GCP has unlocked incredible speed and scale for startups and enterprises alike. But for companies rooted in open source, it has posed a fundamental challenge:..."
date: 2025-05-01
blogCategories:
- "Announcements"
- "News"
...
1. Introducing vector sets—the first new data type in years—created by Salvatore;
1. Integrating Redis Stack technologies, including JSON, Time Series, probabilistic data types, Redis Query Engine and more into core Redis 8 under AGPL;
1. Delivering over 30 performance improvements with up to 87% faster commands and 2x throughput; and
1. Improving community engagement, particularly with client ecosystem contributions.
