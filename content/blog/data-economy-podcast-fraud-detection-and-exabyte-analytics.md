---
title: "The Data Economy: Real-Time Fraud Detection and Exabyte Analytics"
linkTitle: "The Data Economy: Real-Time Fraud Detection and Exabyte Analytics"
url: "/blog/data-economy-podcast-fraud-detection-and-exabyte-analytics/"
...
Eric also oversees DataLabs, Experian’s R&D team that analyzes over an exabyte of data across their four labs. One exabyte is one thousand petabytes, or [50,000 years’ worth of DVD-quality video](https://searchstorage.techtarget.com/definition/exabyte)—in other words, very big data.
...
[Click here to view video](https://www.youtube.com/embed/j5JHeHWQ-EE)
...
Today, organizations are processing [time-series data](/blog/processing-time-series-data-with-redis-and-apache-kafka/), performing [full-text searches on JSON documents](/blog/index-and-query-json-docs-with-redis/), and are building applications with [database-less architectures](/blog/dbless-architecture-and-why-its-the-future/). Technology leaders recognize the importance of simplifying app development with a robust [multi-model data platform](/redis-enterprise/multi-model/) and scaling globally while retaining local response times.

Eric shares insights on Experian’s architecture in the podcast and his perspectives on optimizing [multicloud architectures](/redis-enterprise-cloud/multicloud/), leveraging graph databases, and centralizing multi-business-unit data sources. He also discusses information security, meeting regulatory requirements, and the training Experian requires to ensure data scientists are compliant.
