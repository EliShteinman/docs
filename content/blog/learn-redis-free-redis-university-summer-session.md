---
title: "Learn Redis for Free at the Redis University Summer Session"
linkTitle: "Learn Redis for Free at the Redis University Summer Session"
url: "/blog/learn-redis-free-redis-university-summer-session/"
description: "Summer is a great time for relaxing, unwinding, and picking up a good book. And, personally, I always try to learn something new. But I’ve found it has to be manageable! I admit to failing..."
date: 2019-05-29
blogCategories:
- "Company"
- "Tech"
...
In the interest of providing you with a manageable yet edifying summer learning experience, we’re presenting the [Redis University Summer Session](https://university.redis.com/courses). This June, Redis University will be offering four **free** online courses. Whether you’re an experienced Redis user or completely new to the world’s most-loved database, we have a course to help you make the most of those lazy summer days.
...
There are few better ways to learn Redis than with a Redis University course. We invite you to [sign up now](https://university.redis.com/register), and we’ll see you in class this summer!
