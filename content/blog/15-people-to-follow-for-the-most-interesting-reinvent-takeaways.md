---
title: "15 People to Follow for the Most Interesting re:Invent Takeaways"
linkTitle: "15 People to Follow for the Most Interesting re:Invent Takeaways"
url: "/blog/15-people-to-follow-for-the-most-interesting-reinvent-takeaways/"
description: "AWS re:Invent brings together over 65,000 cloud professionals each year, but it can be hard to shift through the noise and news that this annual Las Vegas conference generates. To help you out,..."
date: 2019-11-27
blogCategories:
- "Company"
authors:
...
Twitter: [@jeffbarr](https://twitter.com/jeffbarr)
...
Twitter: [@jeffblankenburg](https://twitter.com/jeffblankenburg?lang=en)
...
Twitter: [@vboykis](https://twitter.com/vboykis)

Newsletter: [https://vicki.substack.com/](https://vicki.substack.com/)
...
Twitter: [@samcharrington](https://twitter.com/samcharrington)
...
Yan is a consultant and expert on AWS Lambda and serverless computing, and wrote [Production-Ready Serverless: Operational Best Practices](https://www.manning.com/livevideo/production-ready-serverless?a_aid=aws-lambda-in-motion&a_bid=9318fc6f). As stateless architecture are growing in adoption, will we see examples in large-scale production this year at re:Invent?

Twitter: [@theburningmonk](https://twitter.com/theburningmonk)

Website: [https://theburningmonk.com/](https://theburningmonk.com/)
...
Emily is the Modern Operations Advocacy Manager at Microsoft. She wrote the bestselling book [DevOps for Dummies](https://www.amazon.com/DevOps-Dummies-Computer-Tech/dp/1119552222/ref=as_li_ss_tl?ie=UTF8&linkCode=sl1&tag=&linkId=33a0572b3da9c9d7da1e4be78a6d2d2e&language=en_US), and her human approach to building software will provide balance to all the product-centric announcements.

Twitter: [@editingemily](https://twitter.com/editingemily)
...
Twitter: [@abbyfuller](https://twitter.com/abbyfuller)
...
Twitter: [@arungupta](https://twitter.com/arungupta)
...
Twitter: [@cloudpundit](https://twitter.com/cloudpundit)
...
One analyst firm, RedMonk, has charted the rise of developers as the kings within their organizations, or more appropriately the technologies from cloud to containers that has enabled this transformation. You should also follow their entire team directly: [@monkchips](https://twitter.com/monkchips), [@drkellyannfitz](https://twitter.com/drkellyannfitz), [@sogrady](https://twitter.com/sogrady), and [@rstephensme](https://twitter.com/rstephensme) (clockwise from top left).

Twitter: [@redmonk](https://twitter.com/redmonk)
...
Twitter: [@QuinnyPig](https://twitter.com/QuinnyPig)

Website: [https://www.lastweekinaws.com/](https://www.lastweekinaws.com/)

And of course don’t forget to follow [**@Redisinc**](https://twitter.com/Redisinc) for all the happenings in our [booth, sessions, parties, and how you can win some exciting giveaways](/redisconf/)!
