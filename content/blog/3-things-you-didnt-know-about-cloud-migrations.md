---
title: "3 Things You Probably Didn’t Know About the Cloud"
linkTitle: "3 Things You Probably Didn’t Know About the Cloud"
url: "/blog/3-things-you-didnt-know-about-cloud-migrations/"
description: "The cloud is no longer a disruptive new concept. It’s been around for well over 10 years, which may seem short but is an eternity for technology. When AWS’ nascent S3 service launched we were still..."
date: 2021-12-06
blogCategories:
- "Tech"
authors:
...
We decided to compile all of our findings into an infographic we could share with the Redis community: “[How to Migrate to the Cloud Without Disrupting Data](/wp-content/uploads/2021/12/cloud-migration-Infographic.pdf).” Please feel free to share it, too!

Here are a few of our more interesting findings:

## 1 in 3 migrations fail
...
[Watch the video](https://www.unisys.com/news-release/one-in-three-cloud-migrations-fail-unisys-cloud-success-barometer/)

## 92% of companies have a multicloud strategy, but only 45% integrate data

Long gone are the days when companies would vet, select, and [migrate to a single cloud provider](/redis-enterprise-cloud/migrate/). Today, [multicloud is the new norm](/redis-enterprise-cloud/multicloud/). Modern companies seek the operational resilience and freedom to select best-in-breed technologies from among public cloud providers.

[Watch the video](https://resources.flexera.com/web/pdf/report-cm-state-of-the-cloud-2021.pdf)
...
## 1 in 2 companies are working toward managed and optimized use of the cloud across the enterprise
...
[Watch the video](https://d1.awsstatic.com/analyst-reports/Navigate_Disruption_and_Drive_Positive_Business_Outcomes_with_Cloud_Migration.pdf)
...
## Uncover common migration obstacles and learn how to migrate like a winner.

[Watch the video](/wp-content/uploads/2021/12/cloud-migration-Infographic.pdf)
