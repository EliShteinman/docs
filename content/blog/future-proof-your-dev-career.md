---
title: "9 Ways to Future Proof Your Software Developer Career"
linkTitle: "9 Ways to Future Proof Your Software Developer Career"
url: "/blog/future-proof-your-dev-career/"
description: "You need to keep your tech skills current. But a productive career depends on several additional practices."
date: 2023-01-11
blogCategories:
- "Company"
authors:
...
Life is always uncertain, but sometimes it’s more uncertain than usual. That’s definitely the situation for tech industry employees right now, some of whom are nervous about their future. The good news is that the job market will continue to favor software developers in 2023, according to [Forrester](https://www.developer-tech.com/news/2022/dec/01/forrester-jobs-market-continue-favour-developers/). The better news? You can make yourself more valuable to your company and (if that fails) to other employers.
...
## 1. Keep your tech skills up to date

Let’s get the obvious advice out of the way: Don’t let your tech skills go stale.

Pay at least some attention to market demands so that you’re ready to tackle new projects. If you need inspiration for the current hot tech to learn, look in job postings for the sort of work you do or that you want to do next. If lots of those employers are looking for [Kubernetes](/enterprise/redis-enterprise-on-kubernetes/) experience, it’d behoove you to learn Kubernetes.
...
The web is swimming with advice about the most important languages to master, and [Python](/blog/introducing-redis-om-for-python/), Java, [JavaScript](/blog/redis-om-node-js/), and C and C++ routinely are at the top of those lists. According to a recent [StackOverflow developer survey](https://survey.stackoverflow.co/2022/#overview), the three “most loved” languages right now are Rust, Elixir, and Clojure, with salaries reflecting that popularity. But whichever new language you decide to pursue, it’s a good idea to know both a frontend and backend language, advises Lee Atchison, cloud expert and author of [*Caching at Scale with Redis*](/docs/caching-at-scale-with-redis/).

So how to get started? While computer books are still a thing (check out [O’Reilly](https://www.oreilly.com/products/books-videos.html)), particularly when there’s [one topic you want to learn about in-depth](/blog/6-books-new-redis-developers-should-read/), online courses help you learn languages at your own pace. Good places to start include [Udemy](https://www.udemy.com/courses/development/programming-languages/) (courses run about $100 or less), [Coursera](https://www.coursera.org/search?query=programming&) (many courses are free with the option to buy a certificate), and [Codecademy](https://www.codecademy.com/) (free access to basic courses with monthly subscriptions for more advanced study). [LinkedIn Learning](https://www.linkedin.com/learning/topics/programming-languages) also offers courses on a wide variety of technical skills.

## 2. Build on tech fundamentals
...
These essentials aren’t all tech knowledge, per se. Learn to recognize when enough is enough when you’re facing [YAGNI](https://martinfowler.com/bliki/Yagni.html) and when you’ve gotten into the realms of diminishing returns (such as spending months optimizing performance on a rarely used application function). This helps you build a reputation for quality and reliability. Someone who produces clean work that doesn’t require re-work is always in demand.

Languages and development environments change. However, with a firm technical foundation, you can confidently tell a would-be employer, “I’ve learned [dozens of languages](https://www.youtube.com/watch?v=UNSoPa-XQN0) in my career. Adding another one to my skill set is no big deal.”

## 3. Get smarter about systems, not just applications
...
To pick up these skills, here again, LinkedIn Learning offers [DevOps courses](https://www.linkedin.com/learning/topics/devops) on everything from DevOps foundations to more advanced topics. But you don’t need a dedicated class. Begin reading reputable online sources, such as the [DevOps Institute](https://www.devopsinstitute.com/), [DevOps.com](https://devops.com/), and [InfoWorld](https://www.infoworld.com/category/devops/). There’s even a best-selling DevOps novel (yes, really): Gene Kim’s [*The Phoenix Project*](https://www.amazon.com/Phoenix-Project-DevOps-Helping-Business-ebook/dp/B078Y98RG8/ref=tmm_kin_swatch_0?_encoding=UTF8&qid=&sr=).

Similarly, learn more about [cloud](/redis-enterprise-cloud/overview/)-native architectures. Atchison urges developers to learn as much as they can about cloud-native technologies such as [microservices](/solutions/microservices/), [containers](/blog/redis-enterprise-release-using-helm-charts/), and [Kubernetes](/blog/kubernetes-adoption-inception-to-cloud/). Udemy offers a great, free [Basics of Microservices](https://www.udemy.com/course/evolution-of-microservices/?ranMID=39197&ranEAID=CuIbQrBnhiw&ranSiteID=CuIbQrBnhiw-IJTEoQixk79cs.aDp0aPcA&LSNPUBID=CuIbQrBnhiw&utm_source=aff-campaign&utm_medium=udemyads) course. Find similar courses and tutorials on containers and Kubernetes—from introductory 101 courses to advanced concepts—on Udemy, Coursera, LinkedIn Learning, and elsewhere.

## 4. Learn how your work matters to the business

It’s important to understand how the work you do helps the business achieve its goals. Many developers don’t consider the importance of learning more about the business beyond the cubicle walls of the engineering department. As a longtime software developer, [Jim Mischel](https://www.mischel.com/) points out, software developers write programs to solve business problems, but almost anyone can write programs: “If you want to stand out, advance, you have to understand the businesses we serve and the problems they face.”

Developers are [hired to create business value](https://www.kalzumeus.com/2011/10/28/dont-call-yourself-a-programmer/), not to program things. Find ways to [solve problems regularly](https://idiacomputing.com/pub/SustainableCareer-XPDayManhattan.pdf), and you won’t ever have to worry about your career.
...
Tech certifications rarely make a difference to other developers, who prefer to [look at your code](https://towardsdatascience.com/the-most-efficient-way-to-read-code-written-by-someone-else-cb1a05102b76) than at a test score. But they sometimes make a difference to HR departments and to [the salary a company offers you](https://www.roberthalf.com/blog/salaries-and-skills/which-it-certifications-are-most-valuable). Certifications and related training also can be self-affirming and [reduce imposter syndrome](https://www.joblist.com/trends/how-does-imposter-syndrome-affect-the-job-search-process-job-seekers-and-employers-weigh-in) because the external confirmation assures you that you *do* meet a baseline of domain knowledge.

Currently, one way to increase your value to current and future employers is to get a basic cloud certification, recommends Atchison, probably an [AWS certification](https://aws.amazon.com/certification/) or [Google Cloud](https://cloud.google.com/certification) cert. Both providers offer a general foundational cloud certification, but you can pursue a number of advanced certification levels, such as cloud architect, solutions architect, and cloud DevOps engineer. The AWS exam, which costs $100, consists of 65 multiple-choice questions that you must answer within 90 minutes. [Cloud Academy](https://cloudacademy.com/certifications/amazon-aws/) offers quizzes and hands-on labs to help you prepare for the exam. Coursera offers good advice on the [best DevOps certifications](https://www.coursera.org/articles/devops-certifications) to consider.

## 6. Develop people skills and build relationships
...
Personal networking is a crucial soft skill. Learn how to network effectively, [even if you’re shy](https://www.cio.com/article/230572/how-to-network-17-tips-for-shy-people.html). Nurture your connections and friends as if they matter. Because they do.
...
*Do* work on your writing ability, even if it’s just learning how to write a coherent email message. Consider taking a business writing course, such as the ones offered at the [Business Writing Center](https://businesswriting.com/).
...
## 8. Think about the next step in your career
...
Another benefit: You have a [non-vague resume](https://jvns.ca/blog/brag-documents/) that can stand up to deep discussions in job interviews—particularly for the opportunities that come along when you aren’t looking.

Even if you aren’t looking for a job right now, at some point in your career, you will be. So it makes sense to grow your job search skills, including [your interviewing skills](/blog/redis-interview-questions/) before you need them. Interviewing is a separate skill on its own. You should interview often enough that you’re not stressed out by the process. Think of it as a “Hello, world!” project; it’s best to make the dumb mistakes when they don’t matter.
...
Curiosity is one of the most important traits you can have, says life and career coach [Diana Allen](https://www.linkedin.com/in/dianaballen/). “Stay open to new thoughts, ideas, and perspectives. Ask questions to learn,” she advises.

Strive to cultivate a growth mindset, which means believing you are limitless and that your intelligence and ability can be developed further. “Carol Dweck, one of the world’s leading researchers of motivation and mindset and the author of [*Mindset: The New Psychology of Success*](https://www.penguinrandomhouse.com/books/44330/mindset-by-carol-s-dweck-phd/)*, *says one important characteristic of this type of mindset is the willingness to learn from your mistakes and to find value in criticism,” Allen says.
...
## Don’t forget to grow your Redis skills

Always keep learning! And practically speaking, in the short term, that means building on your existing technical knowledge.

Gain Redis mastery with our multi-week courses that teach you how to build robust applications using the entire Redis feature set. You can also demonstrate your mastery by completing the Redis Certified Developer Program. Visit [Redis University](https://university.redis.com/) to enroll for free.
