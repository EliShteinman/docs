---
title: "Redis hits 10 billion Docker pulls—but we’re just getting started"
linkTitle: "Redis hits 10 billion Docker pulls—but we’re just getting started"
url: "/blog/redis-hits-10-billion-docker-pullsbut-were-just-getting-started/"
description: "Seven years ago, in September of 2018, we announced that Redis passed 1 billion pulls on Docker Hub. At the time, we were one of the first technologies to hit that number. A little more than five..."
date: 2025-11-07
blogCategories:
- "Tech"
authors:
...
- **2024:** Redis passes 8 billion Docker pulls. The AI model race is on with OpenAI, Google, Anthropic and Meta all racing to build the smartest model. Vector databases become the hot new piece of infrastructure as the AI tooling ecosystem starts to take shape (we know [someone you should talk to](https://redis.io/lp/get-started2/?utm_campaign=gg_s_core_amer_en_brand_acq_signups_22910335565&utm_source=google&utm_medium=cpc&utm_content=redis_vector&utm_term=&device=c&matchtype=e&gad_source=1&gad_campaignid=22910335565&gbraid=0AAAAADg3Ge_rfxUj5rTsKgjGEeageCn4Z&gclid=Cj0KCQiA5abIBhCaARIsAM3-zFWTlZNwhwuInUX5GxraJOqXj2CC_MDBlz5IzOcxP8PCqHZQmX-hQqkaApDNEALw_wcB) about that).
