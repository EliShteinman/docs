---
title: "The Marketing Buzzwords That Developers Hate"
linkTitle: "The Marketing Buzzwords That Developers Hate"
url: "/blog/the-marketing-buzzwords-that-developers-hate/"
description: "Nobody is motivated to buy a development tool when the marketing pitch is “leverage synergy.”"
date: 2023-01-30
blogCategories:
- "Company"
- "Features"
...
**Digital transformation** is at the top of this list. Sometimes, clever people invent something new that becomes a game-changer. We can all point to tools and technologies that genuinely transformed our lives: [GPS](https://www.nasa.gov/directorates/heo/scan/communications/policy/GPS_History.html). [HTML](https://www.w3.org/People/Raggett/book4/ch02.html). The [camera phone](https://www.sfmoma.org/watch/1997-birth-of-the-camera-phone-2/#:~:text=On%20June%2011th%2C%201997%2C%20Philippe,sent%20photos%20in%20real%20time.).
...
**Agile**, too, is real. [The Agile Manifesto](https://agilemanifesto.org/) disassembled the waterfall development model. Of course, Agile has its detractors, as does any development methodology. I won a journalism award by explaining [why users hate Agile development (and what developers can do about it)](https://www.computerworld.com/article/2828949/why-your-users-hate-agile-development--and-what-you-can-do-about-it-.html), in which I shared wisdom gained the hard way (so that I wouldn’t have to write “best practices”).
...
**Artificial intelligence** (AI) and **machine learning** are important technical endeavors. They are changing the world in important ways, such as in finance, health care, and creating cool avatars to use on Facebook. They also [keep ethicists busy](https://www.weforum.org/agenda/2016/10/top-10-ethical-issues-in-artificial-intelligence/).

But it seems as though any software that searches a [knowledgebase](/blog/how-to-build-a-knowledge-base-platform-using-redis/) is described as “AI-enhanced to deliver the best results,” and any application with an IF statement is lauded as machine learning. “It’s AI-infused!” they promise. Next up: “the new trashcan 5K, powered by AI!”
...
## This expression was clever once, but it’s done now
...
Then there’s tech recruiting. Once, in IT circles, **rock star** meant “master of this domain.” Hiring a “python rock star” or “code ninja” suggested that the developer’s skill went beyond coding, such as a conference speaker or book author. Today, some might say [**10x developer**](https://www.simplethread.com/the-10x-programmer-myth/) (though that implies productivity rather than social status).

Over time, though, “rock star developer” came to mean, “[We want a miracle worker](https://www.cio.com/article/292995/it-organization-the-changing-definition-of-rock-star.html) because we have no idea what we’re doing.” And it’s said by people who forget that rock stars earned [a reputation for poor behavior](https://calendar.songfacts.com/category/musicians-behaving-badly/).
...
- **Refurbished**: Cleaned with a damp cloth
- **Endpoint collaboration device**: It’s a phone
- **Ransomware-proof backups**: Backups that you regularly test
- **Military-grade encryption**: Whatever cost the least when purchased in extreme quantities. Variation: **gaming-grade equipment** (has a blue LED on it).
- **Zero-touch deployment**: We all know you have to touch it.
- **Seamless integration**: Nobody believes this.
- **Hyperconverged architecture**: Too many moving parts, probably.

Fortunately, nobody is using “metaverse” in marketing to developers. Yet.

## What do you even mean to say here?

Some buzzwords are just noise. They make you wonder what the copywriter intended to say. Perhaps nothing.

For example, **synergy** is used to describe the benefits of combining technologies, products, or teams to create something greater than the sum of its parts. As an intention? Sure. As a marketing or corporate buzzword? [No. Just no](https://assets.amuniversal.com/7f52bde09fd7012f2fe600163e41dd5b).
...
You can entertain yourself for hours (presumably during one of those meetings that should have been an email) with [Buzzword Bingo](http://petdance.com/bingo), the classic [Tech Bullshit Generator](https://www.makebullshit.com/), [Buzzword Ipsum](https://www.buzzwordipsum.com/), and the new-and-improved [web economy bullshit generator](https://www.dack.com/web/bullshit.html). And, of course, for your musical enjoyment, you should listen to [Weird Al Yankovic’s Mission Statement](https://www.youtube.com/watch?v=GyV_UG60dD4).
...
[Try Redis now](/try-free/) to find out why we think it’s so wonderful – and why we don’t need buzzwords to show the reasons why.
