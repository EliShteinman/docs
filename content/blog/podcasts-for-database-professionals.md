---
title: "5 Podcasts for Supervillains Who Are Also Database Professionals"
linkTitle: "5 Podcasts for Supervillains Who Are Also Database Professionals"
url: "/blog/podcasts-for-database-professionals/"
description: "These database-related podcasts offer technology and development career advice based on what job you have…and what kind of supervillain you are."
date: 2023-04-10
blogCategories:
- "Tech"
authors:
...
Recommended episode:[ Database observability with millions of users](https://www.dataengineeringshow.com/e/2n611248)
...
Any data engineer could learn from this podcast. But as The Data Engineer Podcast reveals solutions to thorny data problems, it’s of particular interest to supervillains who[ reveal their schemes to the hero](https://www.youtube.com/watch?v=-bpvvOBV-q0) while gloating. Of course, the hero couldn’t possibly foil your plot: You carefully craft your plans and you listen to the Data Engineering Podcast. Truly, you are invincible.

Recommended episode:[ Aligning data security with business productivity to deploy analytics safely and at speed](https://www.dataengineeringpodcast.com/satori-data-security-platform-data-productivity-episode-367)
...
Although it can take years for data to reveal trends, this podcast is for the best kind of supervillain: the mastermind whose far-reaching schemes [take years ](https://www.youtube.com/watch?v=G3ZhdKW6gJo&t=644s/)to unfold. Think, “I created a clone army, then, years later, manipulated events for which I would need a clone army.” Thanks to Drill to Detail, future analysts will be able to analyze your morally questionable work.

Recommended episode:[ Oracle analytics, Luke Skywalker, and the remarkable return of enterprise analytics](https://www.rittmananalytics.com/drilltodetail/2019/7/8/drill-to-detail-ep70-oracle-analytics-luke-skywalker-and-the-remarkable-return-of-enterprise-analytics-featuring-special-guest-bruno-aziza?rq=skywalker)
...
Recommended episode:[ Materialize origins: a timely dataflow story](https://datastackshow.com/podcast/materialize-origins-a-timely-dataflow-story-with-arjun-narayan-and-frank-mcsherry/)

Recommended villain: Obidiah Stane/Ironmonger, *Iron Man*

## [Runs as Radio](https://www.runasradio.com/)
...
Although Microsoft isn’t the Evil Empire it used to be, Microsoft is an industry-standard, and to paraphrase an old adage, nobody ever got fired for buying it. Because of this, it’s the perfect system of choice for a particular breed of supervillain: the one who hides in plain sight. Therefore, this podcast is for the supervillain who, when exposed to a mad cackle,[ has been there all along](https://www.youtube.com/watch?v=P8u8md-NiHM).

Recommended episode:[ Query performance tuning strategies](https://www.runasradio.com/Shows/Show/823)

Recommended villain: Agatha Harkness, Wanda*Vision*

## RIP

While the other podcasts recommended here are, at this time of writing, currently up and running, here’s a shout-out to the fabulous[ RedisPods](https://podcasts.apple.com/us/podcast/redispods/id1499702357), which ran from 2020 to 2021. And while you’re at it, check out Redis’ former podcast,[ The Data Economy](/the-data-economy-podcast/). The advice is useful, though, even if the podcasts are not ongoing.

Trying to improve your database skills? We recommend [video lessons about JSON](/blog/learn-json-from-redis-experts/), the [best database conferences to attend](/blog/database-developers-conferences-2023/), and [how to use leaderboards in your applications even when they aren’t games](/blog/leaderboards-ranked/).
