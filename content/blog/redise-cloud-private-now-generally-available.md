---
title: "Redise Cloud Private is Now Generally Available"
linkTitle: "Redise Cloud Private is Now Generally Available"
url: "/blog/redise-cloud-private-now-generally-available/"
...
Step #1 – [Sign up for a Redis Enterprise Cloud Private account](/redis-cloud-private-documentation/quick-setup/#step1)

Sign up for an account on redis.com. This takes seconds.

Step #2 – [Create an AWS account for RCP](/redis-cloud-private-documentation/quick-setup/#step2)
...
Step #3 – [Create a new subscription](/redis-cloud-private-documentation/quick-setup/#step3)

Choose your data center and subscription options.

Step #4 – [Create your Redis database](/redis-cloud-private-documentation/quick-setup/#step4)
...
Step #5 – [Connect to your Redis database](/redis-cloud-private-documentation/quick-setup/#step5)

Use redis-cli or a simple python app to connect to your deployment.

We are continuing to improve Redis Enterprise Cloud Private. For any questions and feedback, please contact pm.group@redis.com.
