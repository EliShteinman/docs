---
title: "The Data Economy: EA Unlocks Immersive Gaming Experiences with Real-Time Data and Emerging Tech"
linkTitle: "The Data Economy: EA Unlocks Immersive Gaming Experiences with Real-Time Data and Emerging Tech"
url: "/blog/data-economy-electronic-arts-gaming-experiences-with-real-time-data/"
...
*By Isaac Sacolick, Contributor · Published 10 May 2022 · updated 27 March 2025*

![Blog tile image](/images/site-mirror/4ef0ec2d183f75b00a71ce22a9a119a950d5dd38-500x356.webp)
...
It can be easy for technology leaders to get shiny object syndrome—to be dazzled by the promise of NFTs, cryptocurrencies, and the metaverse. and yet, falling behind emerging tech can lead to digital disruption. At [Electronic Arts](https://www.ea.com/) (EA), Farah Ali’s job is to focus on the emerging technologies that will impact her business and customers over the next several years.

Farah is Vice President of Technology Growth Strategy at EA, which is one of the world’s largest video game companies known for a portfolio of well-known titles, including The Sims, Madden, and FIFA. However, EA’s mission goes far beyond developing games. The company focuses on building delightful player experiences by using [gaming](/industries/gaming/), as Farah says, “to build connection and meaning while keeping curiosity alive, and doing so regardless of a player’s age or background.”

Farah, a recent guest of The Data Economy podcast, discusses the important role data plays in improving customer experience, how the [cloud](/try-free/) is helping EA to scale, and many of the challenges companies targeting real-time customer experiences are likely to face.
...
Like many CIOs and [CTOs](/business/), Farah is focused on ensuring EA stays on top of technology trends. At EA, that means making full use of data and planning for the emerging metaverse, along with keeping up with other emerging technologies, such as NFTs, in-car gaming, and more.

[Click here to view video](https://www.youtube.com/embed/c0Lx7kepBFc)

## Identifying the need for real-time data
...
CTOs who are focused on improving real-time customer experiences, developing digitally enabled products, or experimenting with emerging technologies should note that the product, DevOps, and data science organizations will be the first customers of[ real-time data platforms](/redis-enterprise-cloud/overview/).
...
## Estimating traffic for cloud migrations and peak usage periods
